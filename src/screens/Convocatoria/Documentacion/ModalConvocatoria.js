...
export const ModalConvocatoria = ({ openModal, setOpenModal, principalState, setPrincipalState, saveFile, agregarFila, cambiarValor }) => {
    const onCancel = () => {
                        ...
                        <Row gutter={[24, 16]}>
                            <Col span={12}>
                                <Form.Item label="Nombre">
                                    <Input name="nombre"  value={principalState.nombre} onChange={cambiarValor} />
                                </Form.Item>
                            </Col>
                            <Col span={12}>
