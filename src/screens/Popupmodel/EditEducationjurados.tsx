...
export default function EditEducationjurados(props: any) {
  const {
    editData,
    masterData,
    setEditData,
  ...
  const [identityDocumentFile, setIdentityDocumentFile] = useState<any>(null);
  ...
  const onDocumentFile = (event: any) => {
                                    ...
                                    {masterFilter("education").map(
                                      (item: any, i: any) => {
                                        return (
                                          <p
                                            key={i}
                                            className={`form-slct ${editData?.education_level ==
                                              item.id
                                              ? "active"
                                              : ""
                                              }`}
                                      ...
                                      props.citiesData.map((item:any, i:any) => {
                                        return (
                                          <p
                                            ...
                                            className={`form-slct ${item.city_id == editData?.town
                                              ? "active"
                                              : ""
                                              }`}
                                          >
