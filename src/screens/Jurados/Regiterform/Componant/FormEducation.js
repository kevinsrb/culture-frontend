...
import { setDefaultHeader, apiCall, errorToast, successToast } from "../../../../utils/httpClient";
...
export default function FormEducation(props) {
  ...
  const [formalEducationData, setFormalEducationData] = useState([]);
  ...
  async function formSubmit(type, item) {
    if (formValidation()) {
      setIsLoading(true);
  ...
  async function getFormalEducationData(offsetVal) {
    const resData = await localStorage.getItem("resumeData");
    const val = JSON.parse(resData);
    const params = {
                        ...
                        <Grid.Row>
                          ...
                          <Grid.Column>
                            ...
                            <Form.Input
                              ...
                              required={true}
                              error={
                                !formData.qualification && formErrors?.qualification
                              }
                            />
                          </Grid.Column>
                          <Grid.Column>
                                ...
                                >
                                  <Form className="form--dec-input">
                                    ...
                                    <Radio
                                      ...
                                      checked={
                                        formData.graduate_status == 1 ? true : false
                                      }
                                    />
                                    <Radio
                                      name="aa"
                                      ...
                                      checked={
                                        formData.graduate_status == 2 ? true : false
                                      }
                                    />
                                  </Form>
                      ...
                      <Grid columns={1}>
                        <div className="form--tblrow">
                          <Table celled className="main-data-table">
                            ...
                            <Table.Body>
                              {formalEducationData &&
                                formalEducationData.map((item, i) => {
