...
export default function RegistrationForm(props) {
  ...
  function formValidation(item) {
    ...
    if (!formData.identification_cc) {
      formIsValid = false;
      formErrors["identification_cc"] = "C.C. is required !";
    }
    if (!formData.identification_no) {
      formIsValid = false;
      formErrors["identification_no"] = "No. is required !";
    }
    if (!formData.first_name) {
      formIsValid = false;
      formErrors["first_name"] = "Primer nombre is required !";
    }
    if (!formData.gender) {
      formIsValid = false;
      formErrors["gender"] = "Sexo is required !";
    }
    if (!formData.email) {
      formIsValid = false;
      formErrors["email"] = "Correo electrónico is required !";
    }
    if (!formData.mobile) {
      formIsValid = false;
      formErrors["mobile"] = "Celular is required !";
    }
    ...
    if (!formData.city) {
      formIsValid = false;
      formErrors["city"] = "Ciudad is required !";
    }
    if (!formData.department) {
      formIsValid = false;
      formErrors["department"] = "Departamento is required !";
    }
    if (!formData.country) {
      formIsValid = false;
      formErrors["country"] = "País is required !";
    }
    if (!formData.second_surname) {
      formIsValid = false;
      formErrors["second_surname"] = "Segundo apellido is required !";
    }
    if (!formData.first_surname) {
      formIsValid = false;
      formErrors["first_surname"] = "Primer apellido is required !";
    }
    if (!formData.middle_name) {
      formIsValid = false;
      formErrors["middle_name"] = "Segundo nombre is required !";
    }
    if (!formData.description) {
      formIsValid = false;
      formErrors["description"] = "Perfil is required !";
    }
    if (!selectDatePk) {
      formIsValid = false;
      formErrors["birth_date"] = "Middle name is required !";
    }
    if (!identiSelectFile) {
      formIsValid = false;
      formErrors["identityDocument"] = "Identity document is required !";
    }
  ...
  async function swornResumeCreate() {
    ...
    if (formValidation()) {
      ...
      formdataSave.append("address", formData.address);
  ...
  const onFilechangeFile = (event) => {
    console.log("event:  onFilechangeFile", event.target.files[0]);
                      ...
                      <Form className="form--dec-input">
                        ...
                        >
                          <Input
                            label={{ basic: true, content: "Adjuntar" }}
                            labelPosition="right"
                            placeholder={identiSelectFile?.name}
                            className="usr--img-input"
                          />
                        </div>
                      </Form>
                    ...
                    <Grid.Column>
                      ...
                      <Form.Group>
                        <Form.Select
                          ...
                          required={true}
                          error={formErrors?.identification_cc}
                        />
                        ...
                        <Form.Input
                          ...
                          required={true}
                          error={formErrors?.identification_no}
                        />
                      </Form.Group>
                      <Grid>
                  ...
                  <Grid.Row>
                    ...
                    <Grid.Column>
                      <Form.Input
                        ...
                        error={!formData.address && formErrors?.address}
                      />
