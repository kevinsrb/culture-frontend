...
export default function BuscarConvocatorias() {
  return (
    <>
      <Row style={{ backgroundColor: "#3467CC" }}>
        <Col style={{ paddingLeft: "10%" }}>GOV</Col>
      </Row>
      <Row style={{ backgroundColor: "#E6EFFD", paddingTop: "0.5%", paddingBottom: "0.5%", alignItems: "center" }}>
        ...
        <Col style={{ width: "50%", paddingLeft: "1%" }}>
          <Row style={{ flexDirection: "column" }}>
            ...
            <Col>
              <Title className="font-family-Montserrat-Regular font-size-10px">Secretaria de cultura ciudadana</Title>
            </Col>
          </Row>
        </Col>
      </Row>
      ...
      <Row style={{ backgroundColor: "#3366CC", paddingTop: "0.5%", paddingBottom: "0.5%", alignItems: "center" }}>
         <Footer />
      </Row>
    </>
  );
