    ...
    return (
        <div>
            <Modal className="eval_pro_model" visible={isModalVisible} width={1000} footer={false}>
                <MaestraCategoryModel setIsModalVisible={setIsModalVisible} />
            </Modal>
                        ...
                        <Grid.Column className="form--right-box">
                            ...
                            <Layout className='licn_containt_area p-1'>
                                <Content className='licn_add_cat_head text-right'>
                                    <span className='licn_add_text'> <span style={{marginRight:8}}> Crear</span> <a  onClick={()=>setIsModalVisible(true)}><PlusOutlined className='add_icone' /> </a></span>
                                </Content>
