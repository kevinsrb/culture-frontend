...
export default function ConvocatoriasCiclos() {
...
//  columnas
    const columns = [
        ...
        {
            title: <span className='as_tbl_hd'>Nombre Ciclo</span>,
            width: 600,
            dataIndex: "nombre_ciclo",
            key: "nombre_ciclo",
        },
        {
    ...
    function editCategory() {
        ...
        //@ts-ignore
        arr[editCategoryIndex].nombre_ciclo = editCategoryData?.nombre_ciclo;
                                        ...
                                        <Content className="evalpro_table_head asgevl_tbl_head">
                                            <Row>
                                                <Col span={10} className='headin_box'>
                                                    <h4 className='title licn_title font-family-Montserrat-SemiBold'>Gestión Ciclos</h4>
                                                </Col>
                                                <Col span={14}>
