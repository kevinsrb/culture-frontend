                    ...
                    <Content className='mdl_header_containt'>
                        <Row className='tbl_md_heading_box'>
                            <Col span={12} className=''>
                                <h3 className='asgevl_mdl_form_head'>Editar Nombre Ciclo</h3>
                            </Col>
                    ...
                    <Content className=''> 
                        <Form>
                            <Content className='mt-2 mb-1'>
                                ...
                                })} type="text" value={editCategoryData?.nombre_ciclo} className='eval-input evl_cat_input cat_bold' placeholder='Nombre entidad' />
                            </Content>
                        </Form>
                    </Content>
                </Content>
