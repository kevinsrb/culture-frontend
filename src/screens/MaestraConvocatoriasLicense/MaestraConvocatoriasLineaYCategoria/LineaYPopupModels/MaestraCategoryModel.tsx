        ...
        },
        {
            ...
            render: (text: any, record: any, index: any) => (
                ...
                <p className='text-center'>
                    <a onClick={() => handelEditCategory(record, index)} ><EditOutlined /></a>{"  "}
    ...
    return (
        <div>
            ...
            <Modal className="eval_pro_model" visible={isEditSuccessModal} width={600} footer={false}>
                    <EditSuccessModel setIsEditModalVisible={props.setIsEditModalVisible} setMessageShow={setMessageShow} setIsEditSuccessModal={setIsEditSuccessModal} />
            </Modal>
            ...
            >
                    ...
                    <Content className='mdl_header_containt'>
                        <Row className='tbl_md_heading_box'>
                            <Col span={12} className=''>
                                <h3 className='asgevl_mdl_form_head'>Crear área / categoría</h3>
                            </Col>
                ...
                <Content className='mdl_cat_tbl_head'>
                    <span className='mdl_cat_tbl_title'>Categorías asociadas</span>
                </Content>
