                    ...
                    <Content className='mdl_header_containt'>
                        <Row className='tbl_md_heading_box'>
                            <Col span={12} className=''>
                                <h3 className='asgevl_mdl_form_head'>Editar Línea estratégica</h3>
                            </Col>
                        ...
                        <Form>
                            <Content className='mt-2 mb-1'>
                                ...
                                <Input onChange={(e:any)=>setEditCategoryData({
                                    ...editCategoryData,
                                    nombre_linea_estrateg : e.target.value
                                })} type="text" value={editCategoryData?.nombre_linea_estrateg} className='eval-input evl_cat_input cat_bold' placeholder='Nombre entidad' />
                            </Content>
                        </Form>
                    </Content>
                </Content>
