...
import MaestraCategoryModel from './AreaPopupModels/MaestraCategoryModel'
import EditCategoryModel from './AreaPopupModels/EditCategoryModel'
export default function ConvocatoriasLineaEstrategica() {
...
//  columnas
    const columns = [
        ...
        {
            title: <span className='as_tbl_hd'>Nombre Línea estratégica</span>,
            width: 600,
            dataIndex: "nombre_linea_estrateg",
            key: "nombre_linea_estrateg",
        },
        {
    ...
    function editCategory() {
        ...
        //@ts-ignore
        arr[editCategoryIndex].nombre_linea_estrateg = editCategoryData?.nombre_linea_estrateg;
                ...
                <Grid columns={2}>
                    <Grid.Row>
                        ...
                        <Grid.Column className="form--right-box" >
                            ...
                            <Layout className='licn_containt_area'>
                                        ...
                                        <Content className="evalpro_table_head asgevl_tbl_head">
                                            <Row>
                                                <Col span={10} className='headin_box'>
                                                    <h4 className='title licn_title font-family-Montserrat-SemiBold'>Línea estratégica</h4>
                                                </Col>
                                                <Col span={14}>
