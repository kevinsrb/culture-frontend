...
import MaestraCategoryModel from './GestionarPopupModels/MaestraCategoryModel'
import EditCategoryModel from './GestionarPopupModels/EditCategoryModel'
export default function ConvocatoriasArea() {
    ...
    const columns = [
        ...
        {
            title: <span className='as_tbl_hd'>Nombre actividad cronograma</span>,
            width: 600,
                                        ...
                                        <Content className="evalpro_table_head asgevl_tbl_head">
                                            <Row>
                                                <Col span={10} className='headin_box'>
                                                    <h4 className='title licn_title font-family-Montserrat-SemiBold'>Gestionar actividades cronograma</h4>
                                                </Col>
                                                <Col span={14}>
