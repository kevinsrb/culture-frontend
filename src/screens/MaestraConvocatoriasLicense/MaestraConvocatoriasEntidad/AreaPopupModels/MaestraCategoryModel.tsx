...
export default function MaestraCategoryModel(props: any) {
    ...
    const columns = [
        {
            title: <span className='as_tbl_hd'>Nombre entidad</span>,
            width: 600,
    ...
    function handelCategoryAddForm() {
        if (datosCategory.length > 0) {
            console.log('datosCategory:fff ', datosCategory);
    ...
    function categoryHandelArray() {
        ...
        if (categoryAddStatus == 'Edit') {
            ...
            const valArr: any = editLicenseCategoryData.nombre_entidad;
            setDatosCategory([...arr])
            setcategory({ ...category, category_name: '' })
            setNombreLinea(valArr)
        }
    ...
    function editCategory() {
        ...
        arr[editCategoryIndex].nombre_entidad = editCategoryData?.nombre_entidad;
        setDatosCategory(arr);
    }
                    ...
                    <Content className='mdl_header_containt'>
                        <Row className='tbl_md_heading_box'>
                            <Col span={12} className=''>
                                <h3 className='asgevl_mdl_form_head'>Crear entidad</h3>
                            </Col>
                    ...
                    <Content className=''>
                        <Form>
                            <Content className='mt-2 mb-1'>
                                <label className='form--lable asgevl_form_lable'>Nombre entidad</label>
